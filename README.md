...
# Analyse et diagramme de classes

## Classes principales
- Déterminez les classes et les attributs principaux.
...
Auriez-vous besoin de faire des changements dans votre programme pour intégrer Bobinette dans la vie de Bob ? Si oui, dîtes lesquels.
